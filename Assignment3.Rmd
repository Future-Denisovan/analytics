...
summary(lm128_B) 
summary(lm64_B)
#kable might be good use for this
...
See the model below for a comparison of the multiple R squared values. Once we implemented dummy variables for time, our model was able to capture for between roughly 40-60% more of the variation.
...
I like graphs, so see below for a graph of the coefficients regarding weeks
...
Seasonality-Maybe we should look at this quarterly.
