...
Absence of a difference.....which is interesting. You'd think there would be a difference with taking ACV as a denominator to normalize the quantity....


####
So the cross price elasticity changes for Tide 64's quantity in relation to Tide 128's price. 
It goes from -1.78 to 1.16 (changing signs!) which means that
