...
# 10 of what? The way I see variability is the spread along the x axis. For Price Gap 1 it's from 0-8, for Price Gap 2 it's -3 to 3. 
# Also, why does the homework not include Wisk in the regression models? In the slot management assignment, things were excluded if they didn't have enough variability...
