...
print(whats_my_profit(baseprices3,pricechanges3,marginal_costs3, retail_margin3,quantitychange,ratiocounter3))



# Create a for statement to populate the list
for (i in seq(0, 0.9, by=0.01)) {
  whats_my_profit(baseprices3,pricechanges3,i, retail_margin3,quantitychange,ratiocounter3)
   
   if (whats_my_profit(baseprices3,pricechanges3,i, retail_margin3,quantitychange,ratiocounter3) > 1) {
      print(i)
     elist1 <- c(elist1, i)
   }
}
